...
export class MathClass extends Klass {
    ...
    constructor(module: Module) {
        ...
        this.addAttribute(new Attribute("PI", doublePrimitiveType, (rto) => { return Math.PI }, true, Visibility.public, true, "Die Kreiszahl Pi (3.1415...)"));
        this.addAttribute(new Attribute("E", doublePrimitiveType, (rto) => { return Math.E }, true, Visibility.public, true, "Die Eulersche Zahl e"));
        ...
        this.addMethod(new Method("round", new Parameterlist([
            ...
            (parameters) => {
                return Math.round(<number>parameters[1]);
        ...
        this.addMethod(new Method("floor", new Parameterlist([
            ...
            (parameters) => {
                return Math.floor(<number>parameters[1]);
        ...
        this.addMethod(new Method("ceil", new Parameterlist([
            ...
            (parameters) => {
                return Math.ceil(<number>parameters[1]);
        ...
        this.addMethod(new Method("sqrt", new Parameterlist([
            ...
            (parameters) => {
                return Math.sqrt(<number>parameters[1]);
        ...
        this.addMethod(new Method("pow", new Parameterlist([
            ...
            (parameters) => {
                return Math.pow(<number>parameters[1], <number>parameters[2]);
        ...
        this.addMethod(new Method("toDegrees", new Parameterlist([
            ...
            (parameters) => {
                return (<number>parameters[1]) / Math.PI * 180;
        ...
        this.addMethod(new Method("toRadians", new Parameterlist([
            ...
            (parameters) => {
                return (<number>parameters[1]) / 180 * Math.PI;
        ...
        this.addMethod(new Method("exp", new Parameterlist([
            ...
            (parameters) => {
                return Math.exp(<number>parameters[1]);
        ...
        this.addMethod(new Method("log", new Parameterlist([
            ...
            (parameters) => {
                return Math.log(<number>parameters[1]);
        ...
        this.addMethod(new Method("log10", new Parameterlist([
            ...
            (parameters) => {
                return Math.log10(<number>parameters[1]);
        ...
        this.addMethod(new Method("sin", new Parameterlist([
            ...
            (parameters) => {
                return Math.sin(<number>parameters[1]);
        ...
        this.addMethod(new Method("cos", new Parameterlist([
            ...
            (parameters) => {
                return Math.cos(<number>parameters[1]);
        ...
        this.addMethod(new Method("tan", new Parameterlist([
            ...
            (parameters) => {
                return Math.tan(<number>parameters[1]);
        ...
        this.addMethod(new Method("asin", new Parameterlist([
            ...
            (parameters) => {
                return Math.asin(<number>parameters[1]);
        ...
        this.addMethod(new Method("acos", new Parameterlist([
            ...
            (parameters) => {
                return Math.acos(<number>parameters[1]);
        ...
        this.addMethod(new Method("atan", new Parameterlist([
            ...
            (parameters) => {
                return Math.atan(<number>parameters[1]);
        ...
        this.addMethod(new Method("atan2", new Parameterlist([
            ...
            (parameters) => {
                return Math.atan2(<number>parameters[1], <number>parameters[2]);
        ...
        this.addMethod(new Method("abs", new Parameterlist([
            ...
            (parameters) => {
                return Math.abs(<number>parameters[1]);
        ...
        this.addMethod(new Method("max", new Parameterlist([
            ...
            (parameters) => {
                return Math.max(<number>parameters[1], <number>parameters[2]);
        ...
        this.addMethod(new Method("min", new Parameterlist([
            ...
            (parameters) => {
                return Math.min(<number>parameters[1], <number>parameters[2]);
