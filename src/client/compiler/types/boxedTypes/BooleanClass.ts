...
import { Method, Parameterlist, Type, Value, Attribute, NewValue } from "../Types.js";
...
export class BooleanClass extends Klass {
    ...
    constructor(baseClass: Klass) {
        ...
        this.addAttribute(new Attribute("TRUE", this, (ro) => { return true }, true, Visibility.public, true, "das Boolean-Objekt, das TRUE repräsentiert"));
        this.addAttribute(new Attribute("FALSE", this, (ro) => { return false }, true, Visibility.public, true, "das Boolean-Objekt, das FALSE repräsentiert"));
    ...
    init() {
        ...
        this.addMethod(new Method("Boolean", new Parameterlist([
            ...
            (parameters) => {
                ...
                parameters[0] = parameters[1] != null && (<string>parameters[1]).toLowerCase() == "true";
        ...
        this.addMethod(new Method("booleanValue", new Parameterlist([]), booleanPrimitiveType,
            (parameters) => { return parameters[0]; }, false, false, "Wandelt das Boolean-Objekt in einen boolean-Wert um"));
        ...
        this.addMethod(new Method("hashCode", new Parameterlist([
            ...
            (parameters) => {
                return (<boolean>parameters[0]) ? 0 : 1;
        ...
        this.addMethod(new Method("valueOf", new Parameterlist([
            ...
            (parameters) => {
                return parameters[1] != null && (<string>parameters[1]).toLowerCase() == "true";
